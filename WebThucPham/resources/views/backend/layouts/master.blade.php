                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__left">
                            <ul>
                                ...
                                <li>Free shipping cho đơn hàng 100.000 đồng trở lên</li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6">
                        <div class="header__top__right">
                            ...
                            <div class="header__top__right__auth">
                                ...
                                <a href="{{route('user-order',['id'=>Auth::user()->id])}}"><i class='fas fa-donate' style='font-size:14px'></i> Đơn hàng</a>
                                <a href="{{route('logout')}}" class="text-danger"><i class=""></i> Logout</a>
                                @else
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="header__logo">
                        <a href="{{route('index')}}"><img src="{{asset('backend/img/logo.png')}}" alt=""></a>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-lg-3">
                    <div class="header__cart">
                        <ul>
                            <li><a href="{{route('heart')}}"><i class="fa fa-heart"></i> <span>
                                        <?php
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="hero__search">
                        <div class="hero__search__form">
                            <form action="{{route('search')}}">
                                ...
                                <input type="text" name="name" placeholder="Nhập tên thực phẩm bạn muốn tìm ?">
                    ...
                    <div class="hero__item set-bg" data-setbg="{{asset('backend/img/hero/banner.jpg')}}">
