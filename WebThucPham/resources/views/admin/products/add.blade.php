...
<div class="container-fluid" id="container-wrapper">
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form method="post" action="{{route('add-products')}}" name="products" onsubmit="return validate()">
                @csrf
                <div class="row">
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="ingredient" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputEmail1">Hạn sử dụng</label>
                            <input type="text" name="exp" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                        </div>
                        <div class="form-group">
                    ...
                    <div class="col-6">
                        ...
                        <img style="width:100px; height:120px;" src="" alt="" class="image_choose">
                    </div>
                </div>
